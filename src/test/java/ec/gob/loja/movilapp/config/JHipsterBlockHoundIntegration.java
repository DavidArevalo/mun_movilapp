...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ec.gob.loja.movilapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ec.gob.loja.movilapp.security.DomainUserDetailsService", "createSpringSecurityUser");
